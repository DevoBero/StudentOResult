                ...
                <div class="main-page">
                    <div class="container-fluid">
                        <div class="row page-title-div">
                            <div class="col-md-12">
                                <h2 class="title" align="center">Student-Online-Result</h2>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-8 col-md-offset-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <a href="find-result.php" style="padding-left: 90px" align="">Find-Result</a>
                                        </div>
                                        <div class="col-sm-4">
                                            <a style="padding-left: 200px" align="">CONGRATULATIONS</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
