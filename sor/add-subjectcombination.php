...
if (strlen($_SESSION['alogin']) == "") {
    ...
    <head>
        ...
        <title>SORN Admin Subject Combination </title> 
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="add-subjectcombination.php"></i>Add-Subjectcombination</a></li>
                                        <li><a href="manage-subjectcombination.php"></i>Manage-Subjectconbination</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
