...
if (strlen($_SESSION['alogin']) == "") {
    ...
    <head>
        ...
        <title>SOR Admin| Student Admission< </title> <link rel="stylesheet" href="css/bootstrap.min.css" media="screen">
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li><a href="manage-students.php"><i class="fa fa-users"></i> Manage-Student</a></li>
                                        <li><a href="add-students.php"><i class="fa fa-users"></i> Student Admission</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
